...
\usepackage{multicol}           % For two-column layout without page break
\usepackage[compact]{titlesec}  % Better section title formatting

% Adjust section title spacing for two-column
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\columnwidth]{figures/fig1_performance_comparison.png}
...
\begin{figure*}[!htbp]
\centering
\includegraphics[width=0.9\textwidth]{figures/fig2_weight_stability.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\columnwidth]{figures/fig4_predictive_score.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\columnwidth]{figures/fig3_f1_score.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\columnwidth]{figures/fig5_leverage_effect.png}
